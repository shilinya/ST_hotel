package com.lin.lease.web.app.controller.history;
...
public class BrowsingHistoryController {
    ...
    private Result<IPage<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
        ...
        Long userId = LoginUserHolder.getLoginUser().getUserId();//获取用户的id
        IPage<HistoryItemVo> result= service.listHistory(page,userId);
