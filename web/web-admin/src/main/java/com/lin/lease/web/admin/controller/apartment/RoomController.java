...
import com.lin.lease.web.admin.service.RoomInfoService;
...
public class RoomController {
    ...
    public Result<IPage<RoomItemVo>> pageItem(@RequestParam long current, @RequestParam long size, RoomQueryVo queryVo) {
        ...
        IPage<RoomItemVo> result = roomInfoService.pagserviceeRoomItemByQuery(page, queryVo);
    ...
    public Result<RoomDetailVo> getDetailById(@RequestParam Long id) {
        RoomDetailVo result=roomInfoService.selectRommDetailsById(id);
        return Result.ok(result);
    }
    ...
    public Result updateReleaseStatusById(Long id, ReleaseStatus status) {
        roomInfoService.updateStatusById(id,status);
        return Result.ok();
    }
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        List<RoomInfo> result=roomInfoService.listRoomInfoByApartmentId(id);
        return Result.ok(result);
    }
